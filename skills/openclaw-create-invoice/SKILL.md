...
description: Use this skill when OpenClaw should create a new invoice entry by summarizing current ClickUp work, confirming hours and description with the user on Telegram, and invoking this repository in create mode.
---
...
1. Query ClickUp through MCP for the user’s relevant in-progress work.
...
- Never invent task details when ClickUp MCP returned no relevant tasks.
